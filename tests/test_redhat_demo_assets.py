...
class RedHatDemoAssetsTests(unittest.TestCase):
    def test_portable_excel_lesson_is_complete(self):
        for name in ("chapters.json", "concepts.json", "frames.json", "metadata.json", "transcript.json"):
    ...
    def test_runbook_links_every_fallback_asset_and_metric(self):
        ...
        for name in ("excel-widget", "vllm-engine-live", "vllm-throughput", "paged-attention"):
